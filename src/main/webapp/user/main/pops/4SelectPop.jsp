...
<body>
	<div id="dialog">
	<a href="social.do" style="float:right;">back</a>
		<div id="dialog-bg">
			<div id="dialog-description">Share your ideas!</div>
			<!-- Buttons, both options close the window in this demo -->
			<div id="dialog-buttons">
				<div class="row">
				<a href="javascript:clickTheme('욕실')" class="large green button" id="pop07" data-dismiss="modal" aria-label="Close">BATH<br>ROOM</a>
				<a href="javascript:clickTheme('거실')" class="large red button" id="pop08" data-dismiss="modal" aria-label="Close">LIVING<br>ROOM</a>
				</div>
				<div class="row" style="margin-top:1%;">
				<a href="javascript:clickTheme('침실')" class="large red button" id="pop09" data-dismiss="modal" aria-label="Close">BED<br>ROOM</a> 
				<a href="javascript:clickTheme('주방')" class="large green button" id="pop10" data-dismiss="modal" aria-label="Close">KIT-<br>CHEN</a>
				</div>	
			</div>
