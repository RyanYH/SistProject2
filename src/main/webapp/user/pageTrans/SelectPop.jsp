...
<body>
	<div id="dialog">
		<div id="dialog-bg">
			<div id="dialog-title">What would you do?</div>
			<div id="dialog-description">Share your ideas!</div>
			<!-- Buttons, both options close the window in this demo -->
			<div id="dialog-buttons">
				<a href="#" class="large green button" id="pop05"
					data-dismiss="modal" aria-label="Close">Open Courses!</a> <a
					href="#" class="large red button" id="pop06" data-dismiss="modal"
					aria-label="Close">Just Posting!</a>
			</div>
		</div>
	</div>
</body>
