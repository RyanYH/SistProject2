						...
						<div class="col-md-4 modal-meta" style="background-color: white;">
							<div class="modal-meta-top">
								...
								<div class="img-poster clearfix">
									...
									</a> <strong> <a href="">SIST A</a></strong> <span>14
					...
					<div class="fab btn-group show-on-hover dropup">
						<div data-toggle="tooltip" data-placement="left" title="Compose"
							...
							<button type="button"
								...
								onclick="SelectPop.jsp">
								<span> <i class="fa fa-bolt"></i>
								</span>
							</button>
						</div>
						<ul class="dropdown-menu dropdown-menu-right" role="menu">
							<li><a href="SelectPop.jsp" data-toggle="tooltip" data-placement="left"
								title="Kitchen">KT</a></li>
							<li><a href="#" data-toggle="tooltip" data-placement="left"
								title="Bedroom">BD</a></li>
							<li><a href="#" data-toggle="tooltip" data-placement="left"
								title="Bathroom">BT</a></li>
							<li><a href="#" data-toggle="tooltip" data-placement="left"
								title="LivingRoom">LV</a></li>
						</ul>
					</div>
				</div>
			</div>
