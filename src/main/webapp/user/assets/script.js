...
google.maps.event.addDomListener(window, 'load', init);
    ...
    function init() {
        ...
        var locations = [
['SIST', 'Seoul', '02-336-8546~8', 'www.sist.co.kr', '', 37.5530836, 126.9364692, 'https://mapbuildr.com/assets/img/markers/solid-pin-blue.png']
        ];
        for (i = 0; i < locations.length; i++) {
            ...
            var locations2 = [
['SIST', 'Seoul', '121 1212 2121', 'www.sist.co.kr', 'TEAM3', 38, 128, 'https://mapbuildr.com/assets/img/markers/solid-pin-blue.png']
        ];
        for (i = 0; i < locations.length; i++) {
            if (locations[i][1] =='undefined'){ description ='';} else { description = locations[i][1];}
            if (locations[i][2] =='undefined'){ telephone ='';} else { telephone = locations[i][2];}
